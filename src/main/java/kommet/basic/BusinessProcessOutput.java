...
@Entity(type = AppConfig.BASE_TYPE_PACKAGE + "." + SystemTypes.BUSINESS_PROCESS_OUTPUT_API_NAME)
public class BusinessProcessOutput extends StandardTypeRecordProxy
{
	private String name;
	...
	public BusinessProcessOutput() throws KommetException
	{
		this(null, null);
	}
	
	public BusinessProcessOutput(Record r, EnvData env) throws KommetException
	{
		super(r, true, env);
	}
