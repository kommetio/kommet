...
public class ActionMessagesTag extends KommetTag
{
	private static final long serialVersionUID = 573899296901397363L;
	
	public ActionMessagesTag() throws KommetException
	{
		super();
	}
	...
	public static String getCode (List<String> msgs, String contextPath, int maxMessages, I18nDictionary i18n)
	{
		if (!msgs.isEmpty())
		{
			...
			html.append("<div class=\"msg-tag action-msgs\"><table><tbody><tr><td>");
			html.append("<img src=\"" + contextPath + "/resources/images/infoicon.png" + "\" /></td></td>");
			html.append("<ul>");
